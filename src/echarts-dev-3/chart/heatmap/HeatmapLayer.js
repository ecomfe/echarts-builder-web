...
define(function (require) {
    ...
    Heatmap.prototype = {
         ...
         */
        getCanvas: function(data, width, height, colorMapper) {
            ...
            while(len--) {
                ...
                pixels[id - 3] = gradient[0];
                pixels[id - 2] = gradient[1];
                pixels[id - 1] = gradient[2];
                pixels[id] *= this.option.opacity * gradient[3];
            }
